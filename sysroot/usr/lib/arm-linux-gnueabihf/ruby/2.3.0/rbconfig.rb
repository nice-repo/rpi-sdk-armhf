...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--build=arm-linux-gnueabihf' '--prefix=/usr' '--includedir=$${prefix}/include' '--mandir=$${prefix}/share/man' '--infodir=$${prefix}/share/info' '--sysconfdir=/etc' '--localstatedir=/var' '--disable-silent-rules' '--libexecdir=$${prefix}/lib/ruby2.3' '--disable-maintainer-mode' '--disable-dependency-tracking' '--enable-multiarch' '--target=arm-linux-gnueabihf' '--program-suffix=2.3' '--with-soname=ruby-2.3' '--enable-shared' '--disable-rpath' '--with-baseruby=/usr/bin/ruby' '--with-sitedir=/usr/local/lib/site_ruby' '--with-sitearchdir=/usr/local/lib/arm-linux-gnueabihf/site_ruby' '--enable-ipv6' '--with-dbm-type=gdbm_compat' 'CFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security' 'FCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong' 'FFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong' 'GCJFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong' 'LDFLAGS=-Wl,-z,relro -Wl,-z,now' 'OBJCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security' 'OBJCXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security' '--with-tcltkversion=8.6' '--with-tclConfig-dir=/usr/lib/arm-linux-gnueabihf/tcl8.6/tclConfig.sh' '--with-tkConfig-dir=/usr/lib/arm-linux-gnueabihf/tk8.6/tkConfig.sh' '--with-tcllib=tcl8.6' '--with-tklib=tk8.6' '--with-tcl-include=/usr/include/tcl8.6' '--with-tk-include=/usr/include/tcl8.6' '--with-tcl-lib=/usr/lib/arm-linux-gnueabihf' '--with-tk-lib=/usr/lib/arm-linux-gnueabihf' 'build_alias=arm-linux-gnueabihf' 'target_alias=arm-linux-gnueabihf'"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.3-vQiDHT/ruby2.3-2.3.3=. -fstack-protector-strong -Wformat -Werror=format-security -fPIC"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc"
