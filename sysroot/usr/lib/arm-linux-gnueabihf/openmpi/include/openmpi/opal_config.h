...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -fdebug-prefix-map=/build/openmpi-dLL54P/openmpi-2.0.2=. -fstack-protector-strong -Wformat -Werror=format-security -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2   -I/build/openmpi-dLL54P/openmpi-2.0.2/opal/mca/event/libevent2022/libevent -I/build/openmpi-dLL54P/openmpi-2.0.2/opal/mca/event/libevent2022/libevent/include' FFLAGS='-g -O2 -fdebug-prefix-map=/build/openmpi-dLL54P/openmpi-2.0.2=. -fstack-protector-strong' LDFLAGS='-Wl,-z,relro   -L/usr//lib' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict"
...
#define OMPI_TARBALL_VERSION "2.0.2"
...
/* set to 1 if word-size integers must be aligned to word-size padding to
   prevent bus errors */
#define OPAL_ALIGN_WORD_SIZE_INTEGERS 1
...
#define OPAL_ASSEMBLY_ARCH OPAL_UNSUPPORTED
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 6.3.0
...
#define OPAL_HAVE_CONNECTX_XRC_DOMAINS 1
...
#define OPAL_IDENT_STRING "2.0.2"
...
#define OPAL_PACKAGE_STRING "Open MPI buildd@hasse Distribution"
...
#define OPAL_RELEASE_DATE "Jan 31, 2017"
...
#define OPAL_REPO_REV "v2.0.1-348-ge291d0e"
...
#define OPAL_TARBALL_VERSION "2.0.2"
...
#define ORTE_RELEASE_DATE "Jan 31, 2017"
...
#define ORTE_REPO_REV "v2.0.1-348-ge291d0e"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "2.0.2"
...
#define OSHMEM_TARBALL_VERSION "2.0.2"
...
#define PACKAGE_STRING "Open MPI 2.0.2"
...
#define WRAPPER_EXTRA_LIBS "-lhwloc -lutil -lm "

/* Whether the wrapper compilers add rpath flags by default */
#define WRAPPER_RPATH_SUPPORT "disabled"
